        ...
        <Box style={{ marginTop: '.8rem'  }}>
            <Paper style={{ padding: '1rem', backgroundColor: theme.palette.background.default, color: theme.palette.text.primary }}>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                        <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>About Us</Typography>
                        ...
                        <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>Our Vision</Typography>
                        <Typography variant="body1" paragraph sx={{ textIndent: '20px' }}>
                        ...
                        <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>Our Team</Typography>
                        <Typography variant="body1" paragraph sx={{ textIndent: '20px' }}>
                        ...
                        <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>Our Commitment</Typography>
                        <Typography variant="body1" paragraph sx={{ textIndent: '20px' }}>
