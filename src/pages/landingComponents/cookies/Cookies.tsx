...
const Cookies = () => {
    ...
    return (
        <div className={styles.card} style={{ position: 'fixed', bottom: '20px', left: '20px' }}>
            ...
            <p className={styles.cookieDescription}>This website uses cookies to ensure you get the best experience on our
                site.</p>

            <div className={styles.buttonContainer}>
                <button className={styles.acceptButton} onClick={handleAccept}>Allow</button>
            </div>
        </div>
    );
};
