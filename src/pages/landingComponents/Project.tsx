...
const Project = () => {
    return (
        <Box sx={{ padding: '20px' }}>
            <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>About NeoXonline</Typography>
            <Typography variant="h6" sx={{  marginBottom: '10px', fontSize: '0.67rem' }}>Communication and Learning in One Place</Typography>
            <Typography variant="body1" paragraph sx={{ textIndent: '20px', fontSize: '0.67rem' }}>
            ...
            <Typography variant="h6" sx={{  marginBottom: '10px', fontSize: '0.67rem' }}>Communication: The Key to Success</Typography>
            <Typography variant="body1" paragraph sx={{ textIndent: '20px', fontSize: '0.67rem' }}>
            ...
            <Typography variant="h6" sx={{  marginBottom: '10px', fontSize: '0.67rem' }}>Features of NeoXonline</Typography>
            <Typography variant="body1" paragraph sx={{ textIndent: '20px', fontSize: '0.67rem' }}>
            ...
            <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>The NeoXonline Community</Typography>
            <Typography variant="body1" paragraph sx={{ textIndent: '20px', fontSize: '0.67rem' }}>
            ...
            <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>Opportunities and Benefits</Typography>
            <Typography variant="body1" paragraph sx={{ textIndent: '20px', fontSize: '0.67rem' }}>
            ...
            <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', fontSize: '1.34rem' }}>Join Us</Typography>
            <Typography variant="body1" paragraph sx={{ textIndent: '20px', fontSize: '0.67rem' }}>
