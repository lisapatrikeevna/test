...
export const GeneralInfo = () => {
    return <Grid container spacing={2} sx={styles.container}>
        <Grid item xs={12} md={6} sx={styles.descriptionSection}>
            <Typography component='div' marginBottom='12px' variant='h2' fontWeight={500}>One platform to cover all your needs (and more)</Typography>
