...
export const Todolist = (props: PropsType) => {
    const {
        title, tasks, filter, removeTask, addTask, changeTaskStatus, todolistId, removeTodolist, updateTask, updateTodolist
    } = props
    ...
    return (<div>
        ...
        <AddItemForm addItem={addTaskCallback} text={props.newText}/>
        {/*<div>*/}
